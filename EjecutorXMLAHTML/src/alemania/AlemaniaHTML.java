	...
	public static void main(String[] args) {
		...
		try {
			...
			String xqueryString = "xquery version \"3.0\";\r\n" + "\r\n"
					...
					+ "                            <p>DIA: {$alumno/eras:PersonalInformation/DIA/text()}</p>\r\n"
					+ "                            <p>BirthDate: {$alumno/eras:PersonalInformation/BirthDate/text()}</p>\r\n"
					+ "                            <p>Estado: {$alumno/eras:PersonalInformation/Estado/text()}</p>\r\n"
					+ "                        </div>\r\n" + "                        \r\n"
					+ "                        <div class=\"section\">\r\n"
