    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String xqueryString = "xquery version \"3.0\";\r\n"
                    ...
                    + "                            <p>Name: {$alumno/eras:PersonalInformation/Name/text()}</p>\r\n"
                    + "                            <p>Gender: {$alumno/eras:PersonalInformation/Gender/text()}</p>\r\n"
                    + "                            <p>Email: {$alumno/eras:PersonalInformation/Email/text()}</p>\r\n"
                    + "                            <p>Nationality: {$alumno/eras:PersonalInformation/Nationality/text()}</p>\r\n"
                    + "                            <p>DNI: {$alumno/eras:PersonalInformation/DNI/text()}</p>\r\n"
                    + "                            <p>Direccion: {$alumno/eras:PersonalInformation/Direccion/text()}</p>\r\n"
                    + "                            <p>Ciudad: {$alumno/eras:PersonalInformation/Ciudad/text()}</p>\r\n"
                    + "                            <p>Codigo Postal: {$alumno/eras:PersonalInformation/CodigoPostal/text()}</p>\r\n"
                    + "                            <p>Comunidad Autonoma: {$alumno/eras:PersonalInformation/ComunidadAutonoma/text()}</p>\r\n"
                    + "                        </div>\r\n"
                    + "                        \r\n"
                    + "                        <div class=\"section\">\r\n"
